...
alias pythonwin='/cygdrive/c/Python27/Lib/site-packages/pythonwin/Pythonwin.exe'
...
alias add="awk 'BEGIN{sum=0;} {sum=sum+$1;} END {print sum}'"
alias collapse='sed "s:\(.*\):'"'"'\1'"'"':g" /dev/clipboard | tr "\n" "," | tee /dev/clipboard'
